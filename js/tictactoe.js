//test to confirm html and js are well connected
//c = 2 + 2
//document.write(c)
...
//this funcion is for placing an x or o in a square
function placeXOro(squareNumber) {
    //this condition ensures a square has not be selected already
    //the .some() method is used to check each element of selectedSquare 
    //array to see if it contains the square number clicked on. see line 4
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === "X") {
            ...
            select.style.backgroundImage = 'url("images/person.png")';
        //Active play may only be "X" or "O", so if not "X", it must be "O"
        } else {
            //if activePlayer is equal to "O", the o.png is placed in HTML
            select.style.backgroundImage = 'url("images/computer.png")';
        }
        ...
        //checking that selectedSquares going into the array
        //console.log(selectedSquares) - checked it does go into the array
        //this function plays placement sound
        audio('/Bottle Rocket-SoundBible.com-332895117_place.mp3')
    ...
    function computersTurn () {
        ...
        while (!success) {
            ...
            //if the random number evaluates return true, the square
            //the square has not been selected yet
...
//this function parses the selectedSquares array to search for win
//conditions. drawLine function is called to draw a line if condition is met
function checkWinConditions() {
    ...
    //and 9 squares are selected, the code executes
        ...
        audio('media/Ta Da-SoundBible.com-1884170640_tie.mp3');
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //true is returned and our else if condition executes
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        function animateLineDrawing () {
            ...
            //this method clears the content from the last loop iteration
        ...
        audio('media/Ovation-Mike_Koenig-1061486511_win.mp3');
